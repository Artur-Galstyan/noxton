...
from noxton.nn import BatchNorm, ConvNormActivation, SqueezeExcitation
...
def test_Conv2dNormActivation_parametrized(
    ...
    # Create JAX version
    jax_conv2d_norm_act = eqx.nn.make_with_state(ConvNormActivation)(
        2,
        in_channels,
        out_channels,
    ...
    jax_conv2d_norm_act, state = autoconvert(jax_conv2d_norm_act, weights_dict)
