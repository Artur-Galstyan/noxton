...
def test_batch_norm_against_pytorch_ndim_1():
    ...
    for b in range(n_batches):
        ...
        running_mean_j = bs.get(bn.running_mean)
        ...
        running_var_j = bs.get(bn.running_var)
...
def test_batch_norm_inference_ndim_1():
    ...
    for b in range(n_batches_infer):
        ...
        new_running_mean_j = bs.get(bn.running_mean)
        ...
        new_running_var_j = bs.get(bn.running_var)
