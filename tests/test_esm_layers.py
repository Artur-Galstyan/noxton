...
from noxton.models.esm.esm import ESM3 as JaxESM3
from noxton.models.esm.esm import ESMC as JaxESMC
from noxton.models.esm.esm import VQVAE_SPECIAL_TOKENS, ESMMultiHeadAttention
from noxton.models.esm.esm import (
    Affine3D as JaxAffine3D,
)
from noxton.models.esm.esm import Dim6RotStructureHead as JaxDim6Rot
from noxton.models.esm.esm import EncodeInputs as JaxEncodeInputs
from noxton.models.esm.esm import (
    GeometricReasoningOriginalImpl as JaxGeomAttn,
)
from noxton.models.esm.esm import OutputHeads as JaxOutputHeads
from noxton.models.esm.esm import PairwisePredictionHead as JaxPairwisePredictionHead
from noxton.models.esm.esm import (
    RotationMatrix as JaxRotationMatrix,
)
from noxton.models.esm.esm import StructureTokenDecoder as JaxStructureTokenDecoder
from noxton.models.esm.esm import TransformerStack as JaxTransformerStack
from noxton.models.esm.esm import UnifiedTransformerBlock as JaxBlock
...
def test_esm3_forward_debug():
    ...
    from noxton.models.esm.esm import Affine3D as JaxAffine3D
...
def test_full_model_esmc(model_name):
    ...
    assert torch_output.embeddings is not None
    assert torch_output.hidden_states is not None
...
def test_full_model_esm3():
    ...
    assert sequence_tokens is not None
